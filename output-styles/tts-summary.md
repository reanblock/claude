...
2. Add the heading: `## Audio Summary for Darren`
3. Craft a message that speaks DIRECTLY to Darren about what you did for them
4. Execute the TTS command to announce what you accomplished:

```bash
uv run ~/~/.claude/hooks/utils/tts/elevenlabs_tts.py "YOUR_MESSAGE_TO_DARREN"
```

## Communication Guidelines

- **Address Darren directly** when appropriate: "Darren, I've updated your..." or "Fixed the bug in..." 
- **Focus on outcomes** for the user: what they can now do, what's been improved
- **Be conversational** - speak as if telling Darren what you just did
...
## Audio Summary for Darren

Darren, I've created three new output styles to customize how you receive information.

```bash
uv run ~/.claude/hooks/utils/tts/elevenlabs_tts.py "Darren, I've created three new output styles to customize how you receive information."
```
